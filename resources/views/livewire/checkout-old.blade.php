                                                ...
                                                <div class="radio-group" style="display: flex; gap: 20px;">
                                                    ...
                                                    <div class="radio-option"
                                                        ...
                                                        <input type="radio" id="paymentMethodWallet"
                                                               ...
                                                               value="wallet"
                                                               class="hidden-radio" {{ $walletBalance >= $total ? '' : 'disabled' }}>
                                                        <label for="paymentMethodWallet" class="payment-label"
                                                               style="{{ $walletBalance < $total ? 'opacity: 0.5; pointer-events: none;' : '' }}">
                                                            <img
...
{{--                                 <th class="border-top-0" style="width: 110px;" scope="col">Sản phẩm</th> --}}
                                <th class="border-top-0" scope="col" width="65%">Sản phẩm</th>
...
{{--                                              src="{{asset('storage/' . $item->product->image )}}" alt="product-img" --}}
...
{{--                                     </th> --}}
                            ...
                            <tr>
                                <td >
                                    <h5 class="font-size-14 m-0">Thuế ước tính :</h5>
                                </td>
                                <td>
                                    0đ
                                </td>
